...
SDL_Surface *screen=NULL; SDL_Surface *italy2=NULL; SDL_Surface *repo1=NULL; SDL_Surface *repo2=NULL; SDL_Surface *repo3=NULL; 
...
italy2 = IMG_Load("question 2.png");
if(!italy2)
{printf("unable to load enigme1: %s\n" ,SDL_GetError());}

repo1= IMG_Load("Q2 vrai.png");
if(!repo1)
{printf("unable to load : %s\n" ,SDL_GetError());}

repo2= IMG_Load("Q2 faux.png");
if(!repo2)
{printf("unable to load: %s\n" ,SDL_GetError());}

repo3= IMG_Load("Q2 faux2.png");
if(!repo3)
{printf("unable to load: %s\n" ,SDL_GetError());}
...
pos1.x=130; pos1.y=180;pos1.w=repo1->w; pos1.h=repo1->h;
pos2.x=130; pos2.y=70; pos2.w=repo2->w; pos2.h=repo2->h;
pos3.x=130 ; pos3.y=300;pos3.w=repo3->w; pos3.h=repo3->h;

SDL_BlitSurface(italy2,NULL,screen,&pos_enigme);
