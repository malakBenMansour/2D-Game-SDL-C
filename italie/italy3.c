...
SDL_Surface *screen=NULL; SDL_Surface *italy3=NULL; SDL_Surface *repo1=NULL; SDL_Surface *repo2=NULL; SDL_Surface *repo3=NULL; 
...
italy3 = IMG_Load("question 3.png");
if(!italy3)
...
SDL_BlitSurface(italy3,NULL,screen,&pos_enigme);
