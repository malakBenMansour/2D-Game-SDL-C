...
SDL_Surface *screen=NULL; SDL_Surface *inde2=NULL; SDL_Surface *repo1=NULL; SDL_Surface *repo2=NULL; SDL_Surface *repo3=NULL; 
...
inde2 = IMG_Load("question2.png");
if(!inde2)
{printf("unable to load enigme1: %s\n" ,SDL_GetError());}

repo1= IMG_Load("Q2vrai.png");
if(!repo1)
{printf("unable to load : %s\n" ,SDL_GetError());}

repo2= IMG_Load("Q2faux.png");
if(!repo2)
{printf("unable to load: %s\n" ,SDL_GetError());}

repo3= IMG_Load("Q2faux2.png");
if(!repo3)
{printf("unable to load: %s\n" ,SDL_GetError());}
...
pos3.x=130; pos3.y=250;
pos2.x=130; pos2.y=150;
pos1.x=130 ; pos1.y=350;

SDL_BlitSurface(inde2,NULL,screen,&pos_enigme);
