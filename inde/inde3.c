...
SDL_Surface *screen=NULL; SDL_Surface *inde3=NULL; SDL_Surface *repo1=NULL; SDL_Surface *repo2=NULL; SDL_Surface *repo3=NULL; 
...
inde3 = IMG_Load("question3.png");
if(!inde3)
{printf("unable to load enigme1: %s\n" ,SDL_GetError());}

repo1= IMG_Load("Q3vrai.png");
if(!repo1)
{printf("unable to load : %s\n" ,SDL_GetError());}

repo2= IMG_Load("Q3faux.png");
if(!repo2)
{printf("unable to load: %s\n" ,SDL_GetError());}

repo3= IMG_Load("Q3faux2.png");
if(!repo3)
{printf("unable to load: %s\n" ,SDL_GetError());}
...
SDL_BlitSurface(inde3,NULL,screen,&pos_enigme);
