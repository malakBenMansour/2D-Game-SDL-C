...
SDL_Surface *screen=NULL; SDL_Surface *inde1=NULL; SDL_Surface *repo1=NULL; SDL_Surface *repo2=NULL; SDL_Surface *repo3=NULL; 
...
inde1 = IMG_Load("question1.png");
if(!inde1)
{printf("unable to load enigme1: %s\n" ,SDL_GetError());}

repo1= IMG_Load("Q1vrai.png");
if(!repo1)
{printf("unable to load : %s\n" ,SDL_GetError());}

repo2= IMG_Load("Q1faux.png");
if(!repo2)
{printf("unable to load: %s\n" ,SDL_GetError());}

repo3= IMG_Load("Q1faux2.png");
if(!repo3)
{printf("unable to load: %s\n" ,SDL_GetError());}
...
pos3.x=130; pos3.y=200;
pos2.x=130; pos2.y=100;
pos1.x=130 ; pos1.y=300;

SDL_BlitSurface(inde1,NULL,screen,&pos_enigme);
