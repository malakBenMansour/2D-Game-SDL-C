...
SDL_Surface *screen=NULL; SDL_Surface *enigme1=NULL; SDL_Surface *repo1=NULL; SDL_Surface *repo2=NULL; SDL_Surface *repo3=NULL; 
...
enigme1 = IMG_Load("question1 espagne.png");
if(!enigme1)
...
SDL_BlitSurface(enigme1,NULL,screen,&pos_enigme);
