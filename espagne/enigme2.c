...
SDL_Surface *screen=NULL; SDL_Surface *enigme2=NULL; SDL_Surface *repo1=NULL; SDL_Surface *repo2=NULL; SDL_Surface *repo3=NULL; 
...
enigme2= IMG_Load("question 2 espagne.png");
if(!enigme2)
...
SDL_BlitSurface(enigme2,NULL,screen,&pos_enigme);
