...
strcpy(tableau[3].solution,"10");
strcpy(tableau[4].solution,"10");
strcpy(tableau[5].solution,"accent");
strcpy(tableau[6].solution,"aucun");
strcpy(tableau[7].solution,"a");
strcpy(tableau[8].solution,"b");
